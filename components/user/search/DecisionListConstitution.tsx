...
import DecisionConstitutionCard from "../shared/DecisionConstitutionCard";
import { set } from "date-fns";

const DecisionListConstitution = ({
    initiaDecisions,
    query,
}: {
    initiaDecisions: ConstitutionDecision[];
    query: {
        ...
        <>
            <div className="grid mt-8 gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                {decisions?.map((decision) => {
                    return <DecisionConstitutionCard key={decision._id} decision={decision} />;
                })}
            </div>
            {hasMore && (
                <div
...
export default DecisionListConstitution;
